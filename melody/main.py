...
from melody.model import BaseNN
from melody.dataset import SingingDataset
    ...
    def fit(self, args, learning_params):
        ...
        for epoch in range(1, learning_params['epoch']+1):
            ...
            if epoch % learning_params['valid_freq'] == 0:
                ...
                print('Split Valid Loss: Onset {:.4f} Offset {:.4f} Pitch Octave {:.4f} Pitch Class {:.4f}\n'.format(
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--train_dataset_path', default='./MIR-ST500/example.pkl', help='path to the train set')
    parser.add_argument('--train_dataset_path', default='./MIR-ST500/train.pkl', help='path to the train set')
    parser.add_argument('--valid_dataset_path', default='./MIR-ST500/valid.pkl', help='path to the valid set')
    # parser.add_argument('--valid_dataset_path', default='./MIR-ST500/example.pkl', help='path to the valid set')
